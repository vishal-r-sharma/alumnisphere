...
function Login() {
  return (
    <div className="w-[90%] md:w-[73%] h-auto bg-[#EBEAFF] flex flex-wrap md:flex-nowrap justify-evenly items-center p-6 rounded-lg shadow-lg gap-6">
      ...
      {/* Form Section */}
      <form className="flex flex-col gap-4 w-full max-w-xs md:max-w-md" action="/signup">
<div className="flex flex-col gap-4 w-full max-w-xs md:max-w-md">
        ...
        <h2 className="text-2xl font-semibold text-gray-600 text-center">Welcome back!</h2>
        ...
        <p className="text-center text-gray-700 text-lg">
          Don’t have an account? <a href="/signup" className="text-[#117554] font-semibold hover:underline">Sign Up</a>
        </p>
    </form>
